...
import exercise2.inventory.Inventory;
import exercise2.inventory.Product;
import exercise2.inventory.Warehouse;
...
public class Main {
    public static void main(String[] args) {
        ...
        warehouse.inventories = "Placeholder"; // Placeholder for now, later we'll create an ArrayList of Inventory
                                               // objects
